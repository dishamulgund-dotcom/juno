  ...
  return (
    ...
    >
      ...
      {/* =========================================================================
          ...
          ========================================================================= */}
      <header className="relative z-10 w-full px-6 sm:px-12 py-3.5 sm:py-4.5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-xs backdrop-blur-2xs font-sans">
        <div className="flex items-center gap-3">
          <span className="flex items-center gap-1.5 text-[#073B5C] bg-[#FFFFFF]/95 px-3.5 py-1 rounded-full border border-[#00B4D8]/35 text-[11px] sm:text-[12px] font-bold shadow-xs">
        ...
        <div className="flex items-center gap-3 text-[11px] sm:text-[12px] text-[#073B5C] uppercase tracking-[0.2em] font-bold">
      ...
      {/* =========================================================================
          ...
          ========================================================================= */}
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center text-center px-4 py-4 sm:py-6">
        <div 
          className="max-w-4xl flex flex-col items-center transition-transform duration-500 ease-out"
          style={{
        ...
        >
          ...
          <div 
            ref={logoRef}
            className={`relative mb-5 sm:mb-6 transition-all duration-1000 ease-out ${
          ...
          >
            ...
            {/* JUNO Master Artwork */}
            <div className="relative w-[320px] sm:w-[440px] md:w-[490px] h-[100px] sm:h-[140px] md:h-[160px]">
              <Image
                src="/images/juno-logo.png"
                alt="Juno Healthcare Private Limited"
                fill
                priority
                sizes="(max-width: 640px) 320px, (max-width: 768px) 440px, 490px"
          ...
          <div 
            className={`space-y-2.5 sm:space-y-3 mb-6 sm:mb-8 max-w-2xl px-2 transition-all duration-1000 ease-out ${
              introStep >= 3 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-3'
            }`}
          >
            <h1 className="font-editorial text-4xl sm:text-6xl md:text-7xl font-medium tracking-[0.16em] text-[#073B5C] uppercase leading-none">
              PHARMACEUTICAL
              <span className="block text-[#00B4D8] font-normal italic lowercase text-2xl sm:text-4xl md:text-5xl mt-2 tracking-normal font-editorial">
                formulation & marketing
              </span>
            </h1>

            <p className="font-sans text-sm sm:text-base md:text-lg text-[#1A365D] font-normal leading-relaxed max-w-lg mx-auto pt-1">
              &ldquo;Advancing healthcare through quality, responsibility and ethical integrity.&rdquo;
            </p>

            {/* Decorative Two-Tone Accent Bar */}
            <div className="w-16 h-[2.5px] rounded-full mx-auto my-3 flex overflow-hidden">
          ...
          >
            ...
            <button
              ...
              className="group relative inline-flex items-center gap-3.5 px-9 py-3.5 sm:px-11 sm:py-4 bg-gradient-to-r from-[#073B5C] via-[#0D5C91] to-[#00B4D8] text-white text-sm sm:text-base font-sans font-bold uppercase tracking-[0.2em] rounded-full shadow-[0_4px_20px_rgba(7,59,92,0.25)] hover:shadow-[0_8px_30px_rgba(7,59,92,0.35)] transition-all duration-300 transform hover:-translate-y-0.5 focus:outline-none focus:ring-2 focus:ring-[#00B4D8] cursor-pointer"
              aria-label="Enter Juno Healthcare Corporate Platform"
            >
              <span className="relative z-10 font-sans tracking-[0.2em]">ENTER PLATFORM</span>
              <ArrowRight className="w-4.5 h-4.5 relative z-10 text-[#48D4D2] group-hover:translate-x-1.5 transition-transform duration-300" />
              <div className="absolute inset-0 rounded-full bg-white opacity-0 group-hover:opacity-15 transition-opacity" />
            </button>

            {/* Secondary Subtitle */}
            <span className="text-[11px] sm:text-[12px] text-[#073B5C] uppercase tracking-[0.24em] font-sans font-bold">
      ...
      {/* =========================================================================
          ...
          ========================================================================= */}
      <footer className="relative z-10 w-full px-6 sm:px-12 py-3.5 sm:py-4.5 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-sans tracking-widest text-[#073B5C] backdrop-blur-2xs">
        <div className="flex items-center text-[11px] sm:text-[12px]">
          <span className="uppercase tracking-[0.18em] font-bold text-[#073B5C]">
            PHARMACEUTICAL MARKETING • QUALITY DRIVEN • PEOPLE FOCUSED
          </span>
        </div>

        <div className="flex flex-wrap items-center justify-center sm:justify-end gap-5 sm:gap-6 text-[11px] sm:text-[12px]">
          {/* Official Phone */}
          <a 
            href="tel:+919743094555" 
            className="hover:text-[#00B4D8] transition-colors flex items-center gap-1.5 uppercase tracking-[0.15em] font-bold text-[#073B5C]"
          >
          ...
          <span className="text-[#073B5C] flex items-center gap-1.5 uppercase tracking-[0.15em] font-bold">
            <ShieldCheck className="w-3.5 h-3.5 text-[#00B4D8]" />
